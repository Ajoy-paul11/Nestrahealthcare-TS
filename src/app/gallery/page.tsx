      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 blue-shade-bg text-white-background">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-8 text-white/90">
            Take a tour through our warm, welcoming spaces designed for comfort,
            safety, and joy
          </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-[#025F67] to-[#2F9D94]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm lg:text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Nothing compares to seeing our warm, welcoming environment
            firsthand. Schedule a visit to tour our facilities and meet our
            compassionate team.
          </p>
          <Link
            href="/contact"
            className="px-8 py-4 bg-white text-[#025F67] rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-300 text-sm lg:text-base"
          >
            Schedule a Visit
          </Link>
        </div>
