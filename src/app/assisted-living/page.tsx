                ...
                <div className="bg-gradient-to-br from-[#025F67] to-[#2F9D94] rounded-2xl p-8 shadow-2xl">
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      <IconCheck className="text-white mt-1 flex-shrink-0" size={24} />
              ...
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-lg lg:text-xl font-bold text-[#025F67] mb-4">
                      {feature.title}
                    </h3>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#025F67] to-[#2F9D94]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href={"/contact"} className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-semibold hover:bg-white hover:text-[#025F67] transition-colors duration-300 text-sm lg:text-base">
                Contact Us
              </Link>
            </div>
          </div>
